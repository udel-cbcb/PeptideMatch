...
public class MatchGetApiServiceImpl extends MatchGetApiService {
	@Override
	public Response matchGetGetJSON(String peptides, String taxonids, Boolean swissprot, Boolean isoform, Boolean uniref100, Boolean leqi, Integer offset,
	...
	@Override
	public Response matchGetGetFASTA(String peptides, String taxonids, Boolean swissprot, Boolean isoform, Boolean uniref100, Boolean leqi, Integer offset, Integer size,
	...
	@Override
	public Response matchGetGetTSV(String peptides, String taxonids, Boolean swissprot, Boolean isoform, Boolean uniref100, Boolean leqi, Integer offset, Integer size,
			SecurityContext securityContext) throws NotFoundException {
		if (MatchServiceUtil.validateInputs(peptides) != null) {
			return Response.status(Response.Status.BAD_REQUEST).entity(MatchServiceUtil.validateInputs(peptides)).build();
		}
	...
	@Override
	public Response matchGetGetXML(String peptides, String taxonids, Boolean swissprot, Boolean isoform, Boolean uniref100, Boolean leqi, Integer offset, Integer size,
			SecurityContext securityContext) throws NotFoundException {
		if (MatchServiceUtil.validateInputs(peptides) != null) {
			return Response.status(Response.Status.BAD_REQUEST).entity(MatchServiceUtil.validateInputs(peptides)).build();
		}
