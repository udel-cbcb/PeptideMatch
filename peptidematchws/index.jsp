		...
		<div class="container">
			<div class="row">
				<div class="span12">
					...
					<p>POST a query to
						http://peptidesearch.uniprot.org/asyncrest/
					<pre>
POST http://peptidesearch.uniprot.org/asyncrest/ HTTP/1.1
...
lEQi:on                    		
					...
					The query consists of a list of comma separated list of peptides, comma separated list of NCBI taxIds and option flag
					...
					actual search result resource, it would send a location to a job
					status resource.
					<pre>
HTTP/1.1 202 Accepted
Location: http://peptidesearch.uniprot.org/asyncrest/jobs/PM201602291d5444276668425dbb05a2044c4c15c4
</pre>
					</p>
					<p>
					<h3>Client requests the job status</h3>
					<pre>
GET http://peptidesearch.uniprot.org/asyncrest/jobs/PM201602291d5444276668425dbb05a2044c4c15c4 HTTP/1.1
</pre>
					</p>
