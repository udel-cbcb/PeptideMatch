	...
	if(request.getParameter("jobId") != null) {
		...
		if(content.length() == 0) {
			...
			if(logHeader.length() == 0) {
				...
				content = logHeader;
				content += "<br/>";
				String proteinHitMapFile = batchWD+"/"+parentDir+"/"+jobId+"/proteinHitMap.html";
				proteinHitMap = readFile(proteinHitMapFile);
...
jQuery(document).ready(function ($) {
	...
	'columnDefs': [
        ...
        initComplete: function(settings) {
            $('#proteinhitmap').colResizable({liveDrag:true});
        },
...
<table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff" border="0" >
	...
	<tr valign="top"> 
			...
			<a class="button current" href="batchresultproteinhitmap.jsp?jobId=<%=jobId%>">Matches By Protein View</a>
