...
/*if(!organism_ID.toLowerCase().equals("all")){
	peptideQuery.queryByPeptideWithOrganismAndTaxonId(originalQuery, organism_ID,taxon_id, start, rowsPerPage, op, swissprot, isoform, uniref100Only, ilEquivalent, sortBy, trOnly, isoOnly);
}
else{
*/
...
<input type="hidden" name="trOnly" value="<%=trOnlyValue%>" >
<input type="hidden" name="isoOnly" value="<%=isoOnlyValue%>" >
...
<%=version%><%
	...
	out.print("<br/>Query organism: "+"<a href='http://www.ncbi.nlm.nih.gov/Taxonomy/Browser/wwwtax.cgi?lvl=0&id="+request.getParameter("taxon_id")+"'>"+request.getParameter("taxon_name")+"</a>");
%>
<!--
...
<tr>
<!--
ortTable(initialed,keyword,organism_id,taxon_id,taxon_name,taxongroup_id,group_name,start,rows,numberfound,swissprot,isoform,uniref100Value,lEqiValue,header_id)
-->
...
%>
<th width=11% id="ac_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Protein AC</b></th>
<th width=9%  id="proteinID_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Protein ID</b></th>
<th width=15% id ="proteinName_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)" ><b>Protein Name</b></th>
<th width=5%  id="length_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)" ><b>Length</b></th>
<th width=15% id ="organismName_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Organism</b></th>
<th style="background-color:#C1D0DF"><b>Match Range</b></th>	
<th width=13% id="proteomic_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Protein Links to Proteomic DBs</b></th>
<th width=10% id="iedb_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)" ><b>Immune Epitope DB</b></th>
<%
} 
 else {
%>
<th width=12% id="ac_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>UniRef100 Cluster ID</b></th>
<th width=12% id="ac_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Representative Protein AC</b></th>
<th width=15% id ="proteinName_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)" ><b>Protein Name</b></th>
<th width=6%  id="length_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)" ><b>Length</b></th>
<th width=15% id ="organismName_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Organism</b></th>
<th style="background-color:#C1D0DF"><b>Match Range</b></th>	
<th width=13% id="proteomic_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Protein Links to Proteomic DBs</b></th>
<th width=11% id="iedb_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)" ><b>Immune Epitope DB</b></th>
<%
}
%>
<!--
<th width=11% id="ac_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Protein AC</b></th>
<th width=11% id="ac_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','','','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Representative Protein AC</b></th>
<th width=9%  id="proteinID_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Protein ID</b></th>
<th width=15% id ="proteinName_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)" ><b>Protein Name</b></th>
<th width=5%  id="length_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)" ><b>Length</b></th>
<th width=12% id ="organismName_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Organism</b></th>
<th style="background-color:#C1D0DF"><b>Match Range</b></th>	
<th width=13% id="proteomic_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)"><b>Proteomic Databases</b></th>
<th width=10% id="iedb_header" class="header" onclick="sortTable('false','<%=originalQuery%>','<%=organism_ID%>','<%=taxon_id%>','<%=taxon_name%>','','','0','20','<%=numberFound%>','<%=swissprotValue%>','<%=isoformValue%>','<%=uniref100Value%>','<%=lEqiValue%>',this.id)" ><b>IEDB</b></th>
-->
</tr>
</thead>
...
<input style="display:none" id="trOnly" value="<%=trOnlyValue%>"></input>
<input style="display:none" id="isoOnly" value="<%=isoOnlyValue%>"></input>
<input style="display:none" id="constraint" value="withtaxonid"></input>
...
<%	out.println("<script language='javascript'>window.onload=paging(\"false\",\""+originalQuery+"\",\""+organism_ID+"\",\""+taxon_id+"\",\""+taxon_name+"\",\"\",\"\",\"0\",\"20\",\""+numberFound+"\",\""+swissprotValue+"\",\""+isoformValue+"\",\""+uniref100Value+"\",\""+lEqiValue+"\",\""+sortBy+"\",\""+trOnly+"\",\""+isoOnly+"\");</script>");
