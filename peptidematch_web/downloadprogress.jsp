...
/*
        ...
        if(request.getParameter("jobId") != null) {
                ...
                jQuery.get('downloadbatchpeptidematchresults?jobId=jobId', function(progress) {
*/
%>
<html>
<head>
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
        <script type="text/javascript">
            ...
            function checkProgress() {
                jQuery.get('downloadbatchpeptidematchresults', function(progress) {
                    jQuery('#progress').html(progress);
                        if(progress.indexOf("Ready for downloading") == -1) {
      ...
      <td align="left" valign="top"> 
        <table background="./imagefiles/spacer.gif" width="686" border="0" cellpadding="3" cellspacing="0" class="nrm02">
          <tbody>
            ...
            <tr> 
              <td colspan="2" align="center" nowrap="" class="footer3"><span class="nrm10"><font color="#999999"> &copy; 2017</font>
