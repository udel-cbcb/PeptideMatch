	...
	if(request.getParameter("jobId") != null) {
		...
		if(content.length() == 0) {
			...
			if(logHeader.length() == 0) {
				...
				content = logHeader;
				content += "<br/>";
				String summaryTableFile = batchWD+"/"+parentDir+"/"+jobId+"/summary.html";
				summaryTable = readFile(summaryTableFile);
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
	<title>Multiple Peptide Match Summary (JobID <%= jobId%>) [PIR - Protein Information Resource]</title><!-- ##### page dependent-->
...
<table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff" border="0" >
	...
	<tr valign="top"> 
      		<td align="left">
			<a class="button current" href="batchresultsummary.jsp?jobId=<%=jobId%>">Summary</a>
