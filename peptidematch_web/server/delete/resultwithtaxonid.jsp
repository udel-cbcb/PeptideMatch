...
/*if(!organism_ID.toLowerCase().equals("all")){
	peptideQuery.queryByPeptideWithOrganismAndTaxonId(originalQuery, organism_ID,taxon_id, start, rowsPerPage, op, uniref100Only, ilEquivalent, sortBy);
}
else{
*/
	peptideQuery.queryByPeptideWithTaxonId(originalQuery, taxon_id, start, rowsPerPage, op, uniref100Only, ilEquivalent, sortBy);
//}
}
...
out.println("Check your parameters.");
 %>
