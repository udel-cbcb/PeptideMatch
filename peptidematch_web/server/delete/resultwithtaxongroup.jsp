...
if(!organism_ID.toLowerCase().equals("all")){
	peptideQuery.queryByPeptideWithOrganismAndGroup(originalQuery, organism_ID,taxongroup_id, start, rowsPerPage, uniref100Only, ilEquivalent, sortBy);
}
else{
	peptideQuery.queryByPeptideWithTaxonGroup(originalQuery, taxongroup_id, start, rowsPerPage, uniref100Only, ilEquivalent, sortBy);
}
}
