...
if (numberFound > rowsPerPage) {
	if( start/ rowsPerPage >6)
           out.print("<a href=\"#\" onClick=\"pagingwithlineagetaxonid('true','"+originalQuery+"','"+organism_id+"','"+taxon_id+"','"+taxon_name+"','0','"+rowsPerPage+"','"+numberFound+"','"+uniref100+"','"+lEqi+"','"+sortBy+"')\"><<</a>&nbsp;");

//	if the page is not at the first page, then produce a previous action	
	if(start>0){
                out.print("<a href=\"#\" onClick=\"pagingwithlineagetaxonid('true','"+originalQuery+"','"+organism_id+"','"+taxon_id+"','"+taxon_name+"','"+(start-rowsPerPage)+"','"+rowsPerPage+"','"+numberFound+"','"+uniref100+"','"+lEqi+"','"+sortBy+"')\">[Previous]</a>&nbsp;");
				}
//if the page is at the first 6 page, 
			if (start / rowsPerPage < 6) {
                ...
                out.print("<a href=\"#\" onClick=\"pagingwithlineagetaxonid('true','"+originalQuery+"','"+organism_id+"','"+taxon_id+"','"+taxon_name+"','"+(i-1)*rowsPerPage+"','"+rowsPerPage+"','"+numberFound+"','"+uniref100+"','"+lEqi+"','"+sortBy+"')\"><b>["+i+"]</b></a>&nbsp;");
					else{
                out.print("<a href=\"#\" onClick=\"pagingwithlineagetaxonid('true','"+originalQuery+"','"+organism_id+"','"+taxon_id+"','"+taxon_name+"','"+(i-1)*rowsPerPage+"','"+rowsPerPage+"','"+numberFound+"','"+uniref100+"','"+lEqi+"','"+sortBy+"')\">["+i+"]</a>&nbsp;");
						}
				}
	//if the page is at more then 6, then produce the previous 4 page link and the next 5 page link, if the next 5 page is more than the total  
			...
			if((start+rowsPerPage)<numberFound){
                out.print("<a href=\"#\" onClick=\"pagingwithlineagetaxonid('true','"+originalQuery+"','"+organism_id+"','"+taxon_id+"','"+taxon_name+"','"+(start+rowsPerPage)+"','"+rowsPerPage+"','"+numberFound+"','"+uniref100+"','"+lEqi+"','"+sortBy+"')\">[NEXT]</a>&nbsp;");
			}
			...
			if((numberFound-1)/rowsPerPage+1>10){
                ...
                out.print("<a href=\"#\" onClick=\"pagingwithlineagetaxonid('true','"+originalQuery+"','"+organism_id+"','"+taxon_id+"','"+taxon_name+"','"+((numberFound-1)/rowsPerPage)*rowsPerPage+"','"+rowsPerPage+"','"+numberFound+"','"+uniref100+"','"+lEqi+"','"+sortBy+"')\">>></a>&nbsp;");
			} 
		}
