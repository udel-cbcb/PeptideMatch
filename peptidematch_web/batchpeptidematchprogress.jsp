            ...
            function checkProgress() {
                jQuery.get('batchpeptidematch', function(progress) {
                    jQuery('#progress').html(progress);
                        if(progress.indexOf("Your job has finished successfully") == -1) {
                                setTimeout(checkProgress, 1000);
                        }
			else {
				var jobId = jQuery("div.JobId", progress).text();
				var url ="batchresultsummary.jsp?jobId="+jobId;
				location=url;		
			}
                });
		}
...
function submitform()
{
    document.forms["jobIdForm"].submit();
}
</script>
<!--
<script type="text/javascript">
