...
<%
	...
	if(request.getParameter("uniref100") != null && request.getParameter("uniref100").equals("uniref100")) {
                uniref100Only = "Y";
		uniref100Value = "uniref100";
        }
        if(request.getParameter("lEqi") != null && request.getParameter("lEqi").equals("lEqi")) {
                ilEquivalent = "Y";
		lEqiValue = "lEqi";
        }
...
<script type="text/javascript" src="js/jsTree/_lib/jquery.js"></script>
    <script type="text/javascript" src="js/jsTree/jquery.jstree_1.03.js"></script>
