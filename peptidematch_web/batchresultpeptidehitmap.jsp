	...
	if(request.getParameter("jobId") != null) {
		...
		if(content.length() == 0) {
			...
			if(logHeader.length() == 0) {
				...
				content = logHeader;
				content += "<br/>";
				String peptideHitMapFile = batchWD+"/"+parentDir+"/"+jobId+"/peptideHitMap.html";
				peptideHitMap = readFile(peptideHitMapFile);
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
	<title>Multiple Peptide Match Protein Hit Map (JobID <%= jobId%>) [PIR - Protein Information Resource]</title><!-- ##### page dependent-->
...
jQuery(document).ready(function ($) {
	...
	'columnDefs': [
        ...
        initComplete: function(settings) {
            $('#peptidehitmap').colResizable({liveDrag:true});
        },
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="docTitle"><tbody><tr>
	...
	<br/><br/>
<div style="margin-left: 80px; margin-right: 80px; width: 1200px;">
<table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff" border="0" >
	...
	<tr valign="top"> 
			...
			<a class="button current" href="batchresultpeptidehitmap.jsp?jobId=<%=jobId%>">Matches By Peptide View</a>
