...
<%
	...
	String dataTable  = "$(document).ready(function() {\n";
               ...
               //dataTable += "   \"aLengthMenu\": [[25, 50, 100, -1], [25, 50, 100, \"All\"]],\n";
               dataTable += "   \"aLengthMenu\": [[25, 50, 100], [25, 50, 100]],\n";
               dataTable += "   \"iDisplayLength\": 25,\n";
               dataTable += "   \"aaSorting\": [[1, \"desc\"], [0, \"asc\"]],\n";
               dataTable += "   \"aoColumns\": [{ sWidth: '70%'}, { sWidth: '15%', sClass: \"alignCenter\"}, { sWidth: '15%', sClass: \"alignCenter\"}], \n";
               dataTable += "   \"bProcessing\": true,\n";
               dataTable += "   \"bServerSide\": true,\n";
               dataTable += "   \"sAjaxSource\": \"getorganismtablesource.jsp?peptide="+peptide+"&organism_id="+organism_id+"&numberfound="+numberFound+"\"\n"; 
               dataTable += "   });\n";
               dataTable += "});\n";
				...
				<div>
					<div id="container">
						...
						<table cellpadding=0 cellspacing=0 border=0 class="display" id="example">
							<thead><tr><th>Organism</th><th align=center>Matches</th><th align=center>%</th></tr></thead>
							<tbody>
								<tr>
