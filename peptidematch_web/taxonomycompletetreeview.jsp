...
<table style="font-size: 13px; margin-left: 50px; width:100%"> 
	...
	<td>
  	<div style="width:95%;">
		...
		-->
		<label><span style="font-weight: bold; font-size: 14px;"><a href="taxonomycondensetreeview.jsp?peptide=<%=peptide%>&organism_id=<%=organismId%>&numberfound=<%=numberFound%>&swissprot=<%=swissprotValue%>&isoform=<%=isoformValue%>&uniref100=<%=uniref100Value%>&lEqi=<%=lEqiValue%>">Taxonomy Condense Tree View</a></span> | <span style="font-weight: bold; font-size: 14px; color: brown;">Taxonomy Complete Tree View</span> </label>
    		</div>
  	 </div>
	<br>
