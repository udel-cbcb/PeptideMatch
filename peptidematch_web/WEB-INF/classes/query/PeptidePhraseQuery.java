...
public class PeptidePhraseQuery {
	...
	public void queryByPeptide(String query, int start, int rows, String swissprot, String isoform, String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
		...
		if(isoOnly.equals("Y")) {
			finalQuery += " (isoform:Y AND sptr:sp)";
		}
		else {
			if(trOnly.equals("Y")) {
				finalQuery += " sptr:tr";	
				...
				if(isoform.equals("N")) {
					finalQuery += " isoform:N";	
				}
			}
		}
		System.out.println("queryByPetide: "+ finalQuery+"\n");	
		...
		solrQuery.setParam("sort", "peptideAtlas asc, pride asc, iedb desc, ac asc");
		...
		System.out.println("queryByPeptide sorlQuery: " + solrQuery);
		try {
	...
	public Map<String, Long>  queryByPeptideWithGroup(String query, String swissprot, String isoform, String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
                String queryField = "originalSeq:";
		if(ilEquivalent.equals("Y")) {
                        queryField = "lToiSeq:";
			query = query.replaceAll("L", "I");	
		...
		Map<String, Long> sortedGroupSum = new LinkedHashMap();
                        ...
                        if(groupResponse != null) {
                                ...
                                for(int i=0; i < groupResponseValues.size(); i++) {
                                        ...
                                        for(int j=0; j <groups.size(); j++) {
                                                ...
                                                groupCount.put((String)idToName.get(group.getGroupValue())+"<|>"+group.getGroupValue(), gdocs.getNumFound());
                                        }
                                        //System.out.println();
                                        System.out.println("Before sorting: " + new Date());
                                        sortedGroupSum = sortByValue(groupCount, gcmd.getMatches(), gcmd.getNGroups());
                                        System.out.println("After sorting: " + new Date());
                                        /*for (String organism : sortedGroupSum.keySet()){
                                                System.out.println(organism + " " + sortedGroupSum.get(organism));
                                        }
					*/
                                }
                        }
	...
	public void queryByPeptideWithOrganism(String query, String organism_id, int start, int rows, String uniref100Only, String ilEquivalent, String sortBy) {
	...
	public Map<String, Long> queryByPeptideWithMultiOrganismWithGroup(String query, String organism_ids, String swissprot, String isoform, String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
		HashMap idToName = new HashMap();
                try {
                        InputStream inputStream = this.getClass().getClassLoader().getResourceAsStream("config/taxToTaxGroup.txt");
                        BufferedReader br = new BufferedReader(new InputStreamReader(inputStream));
	...
	public void queryByPeptideWithMultiOrganism(String query, String organism_ids, int start, int rows, String swissprot, String isoform, String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
		// process the peptide into the phrasequery
		String queryField = "originalSeq:";
		if(ilEquivalent.equals("Y")) {
			queryField = "lToiSeq:";
		...
		System.out.println("queryByPeptideWithMultiOrganism solr query:  "+ finalQuery+"\n");
		// connect to the solrQuery
		SolrQuery solrQuery = new SolrQuery();
		SolrDocumentList docs = new SolrDocumentList();
		solrQuery.setParam("q", finalQuery);
	...
	public void queryByPeptideWithOrganismAndGroup(String query, String organism_id, String taxonGroup, int start, int rows, String swissprot, String isoform, String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
		// process the peptide into the phrasequery
		String queryField = "originalSeq:";	
		if(ilEquivalent.equals("Y")) {
			queryField = "lToiSeq:";
	...
	public void queryByPeptideWithOrganismAndTaxonId(String query, String organism_id, String taxon, int start, int rows, String op, String swissprot, String isoform, String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
		// process the peptide into the phrasequery
		String queryField = "originalSeq:";
		if(ilEquivalent.equals("Y")) {
			queryField = "lToiSeq:";
	...
	public void queryByPeptideWithFullLineageOrganismAndTaxonId(String query, String organism_id, String taxon, int start, int rows, String op, String swissprot, String isoform,  String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
                // process the peptide into the phrasequery
		String queryField = "originalSeq:";
		if(ilEquivalent.equals("Y")) {
			queryField = "lToiSeq:";
		...
		if(isoOnly.equals("Y")) {
                ...
                System.out.println("queryByPeptideWithFullLineageOrganismAndTaxonId: "+finalQuery);
                // connect to the solrQuery
                SolrQuery solrQuery = new SolrQuery();
                SolrDocumentList docs = new SolrDocumentList();
                solrQuery.setParam("q", finalQuery);
		...
		if(sortBy.equals("organismName_desc")) {
			solrQuery.setParam("sort", "organismName desc");
                ...
                solrQuery.setStart(start);
                solrQuery.setRows(rows);
                System.out.println("queryByPeptideWithFullLineageOrganismAndTaxonId: "+ solrQuery);
                try {
                        response = solrServer.query(solrQuery, METHOD.POST);
                        docs = response.getResults();
                        if (docs != null) {
	...
	public void queryByPeptideWithTaxonGroup(String query, String taxonGroup, int start, int rows, String swissprot, String isoform, String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
		// process the peptide into the phrasequery
		String queryField = "originalSeq:";
		if(ilEquivalent.equals("Y")) {
			queryField = "lToiSeq:";
	...
	public void queryByPeptideWithTaxonId(String query, String taxonId, int start, int rows, String op, String swissprot, String isoform, String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
		// process the peptide into the phrasequery
		String queryField = "originalSeq:";
		if(ilEquivalent.equals("Y")) {
			queryField = "lToiSeq:";
	...
	public void queryByPeptideWithFullLineageTaxonId(String query, String taxonId, int start, int rows, String op, String swissprot, String isoform, String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
                // process the peptide into the phrasequery
                String queryField = "originalSeq:";
		if(ilEquivalent.equals("Y")) {
			queryField = "lToiSeq:";
		...
		if(isoOnly.equals("Y")) {
                ...
                System.out.println("queryByPeptideWithFullLineageTaxonId: "+finalQuery);
                // connect to the solrQuery
                SolrQuery solrQuery = new SolrQuery();
                SolrDocumentList docs = new SolrDocumentList();
                solrQuery.setParam("q", finalQuery);
		...
		if(sortBy.equals("organismName_desc")) {
			solrQuery.setParam("sort", "organismName desc");
                ...
                solrQuery.setStart(start);
                solrQuery.setRows(rows);
                System.out.println("queryByPeptideWithFullLineageTaxonId: "+solrQuery);
                try {
                        response = solrServer.query(solrQuery, METHOD.POST);
                        docs = response.getResults();
                        if (docs != null) {
	...
	public void queryByID(String ID, String swissprot, String isoform, String uniref100Only, String sortBy, String trOnly, String isoOnly) {
		String queryField = "ac:";
	...
	public void queryByOrganismID(String organism_id, int start, int rows, String swissprot, String isoform,  String uniref100Only, String sortBy, String trOnly, String isoOnly) {
	...
	public void queryByOrganismIDs(String organism_ids, int start, int rows, String swissprot, String isoform, String uniref100Only, String sortBy, String trOnly, String isoOnly) {
		String[] organisms=organism_ids.split(";");
		String organismQuery = "(organismID:" + organisms[0];
		for(int i=1;i<organisms.length;i++){
			organismQuery=organismQuery+" OR organismID:" + organisms[i];
		...
		if(isoOnly.equals("Y")) {
                        organismQuery += " isoform:Y";
                        organismQuery += " sptr:sp";
                }
                else {
                        if(trOnly.equals("Y")) {
                                organismQuery += " sptr:tr";
                        }
                        else {
                                if(swissprot.equals("Y")) {
                                        organismQuery += " sptr:sp";
	...
	public void queryAll(int start, int rows, String swissprot, String isoform, String uniref100Only, String sortBy, String trOnly, String isoOnly) {
		String query = "*:*";
		SolrQuery solrQuery = new SolrQuery();
		SolrDocumentList docs = new SolrDocumentList();
		if(uniref100Only.equals("Y")) {
...
public void queryByPeptideWithShortLineageOrganismAndTaxonId(String query, String organism_id, String taxon, int start, int rows, String op, String swissprot, String isoform, String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
                // process the peptide into the phrasequery
                String queryField = "originalSeq:";
                if(ilEquivalent.equals("Y")) {
                        queryField = "lToiSeq:";
...
public void queryByPeptideWithShortLineageTaxonId(String query, String taxonId, int start, int rows, String op, String swissprot, String isoform, String uniref100Only, String ilEquivalent, String sortBy, String trOnly, String isoOnly) {
                // process the peptide into the phrasequery
                String queryField = "originalSeq:";
                if(ilEquivalent.equals("Y")) {
                        queryField = "lToiSeq:";
