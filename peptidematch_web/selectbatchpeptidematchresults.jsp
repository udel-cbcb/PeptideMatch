 ...
 <tr valign="top">
	...
	a.button {
                ...
                cursor: pointer;
                        ...
                        <a class="button" href="batchresultsummary.jsp?jobId=<%=jobId%>">Summary<a/> <a class="button" href="batchresulttaxongroupview.jsp?jobId=<%=jobId%>">Taxonomic Group View</a> <a class="button" href="batchresultorgview.jsp?jobId=<%=jobId%>">Organism View</a><br/><br/><br/>
                </td>
        </tr>
        <tr valign="top">
                <td align="left">
